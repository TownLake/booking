  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-orange-50 dark:from-gray-900 dark:to-gray-800 flex flex-col items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md mb-6">
        ...
        <p className="text-center mb-6 dark:text-gray-300">your custom 🇵🇹 itinerary - powered by Cloudflare Workers AI and fine-tuned with my favorite recommendations</p>
